		...
		<view class="container_up">
			...
			<view class="detail_content">
				...
				<view class="imgContainer">
					<image :src="'cloud://yanqing-weixin.7961-yanqing-weixin-1302390801/'+shop.image_path"/>
				</view>
				<!-- 店铺简介 -->
				<view class="store">
					...
					db.collection('favorList')
						...
						.get({
							success:({data})=>{
								const shop = data[0];
								if (!shop.image_path) {
									shop.image_path = 'mdata/img/404.jpg';
								}
								console.log('店铺数据',shop);
								resolve(shop);
