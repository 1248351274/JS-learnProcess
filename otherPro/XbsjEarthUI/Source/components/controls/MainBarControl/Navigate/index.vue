...
.globalbutton {
  ...
  background: url(../../../../images/sunwayImg/svg/earth1.svg) no-repeat;
  
    /* background: linear-gradient(to right, rgb(0, 4, 255), rgb(0, 3, 182),rgb(28, 31, 180));
    background: linear-gradient(to right, rgb(20, 3, 252), rgb(20, 3, 252),rgb(20, 3, 252));
    background: linear-gradient(to right, rgb(0,68,137), rgb(0,68,137),rgb(0,68,137));
    background: linear-gradient(to right, rgb(0, 3, 182), rgb(0, 3, 182),rgb(0, 3, 182));
  /* background: linear-gradient(to right, rgb(67, 134, 250), rgb(67, 134, 250), rgb(67, 134, 250)); */
  /* background-size: 80%;                
  -webkit-mask: url(../../../../images/sunwayImg/earth5.png) no-repeat;
  -webkit-mask-size: 100% 100%;
  mask: url(../../../../images/sunwayImg/earth5.png) no-repeat;opacity:1;
  mask-size: 100% 100%; */ 
  background-size: contain;
  cursor: pointer;
}
.globalbutton:hover {
  /* background: linear-gradient(to right, rgb(1, 53, 105), rgb(1, 53, 105), rgb(1, 53, 105));
  background: linear-gradient(to right, rgb(1,68,144), rgb(1,68,144), rgb(1,68,144));
  background: linear-gradient(to right, rgb(3, 82, 252), rgb(3, 82, 252),rgb(3, 82, 252));
  background: linear-gradient(to right, rgb(20, 3, 252), rgb(20, 3, 252),rgb(20, 3, 252));
     background: linear-gradient(to right, rgb(76, 0, 255), rgb(76, 0, 255),rgb(76, 0, 255));
     background: linear-gradient(to right, rgb(0, 4, 255), rgb(0, 4, 255),rgb(0, 4, 255));
     background: linear-gradient(to right, rgb(0, 3, 182), rgb(0, 3, 182),rgb(0, 3, 182));
     background: linear-gradient(to right, rgb(0,68,137), rgb(0,68,137),rgb(0,68,137));
     background: linear-gradient(to right, rgb(0, 3, 182), rgb(0, 3, 182),rgb(0, 3, 182));
  background: linear-gradient(to right, rgb(67, 134, 250), rgb(67, 134, 250), rgb(67, 134, 250));
  ...
  /* background: url(../../../../images/sunwayImg/earth53.png) no-repeat;opacity:0.6;filter: alpha(opacity=60) ; */
  background: url(../../../../images/sunwayImg/svg/earth1-hover.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
.chinabutton {
  background: url(../../../../images/china.png) no-repeat;
  background: url(../../../../images/sunwayImg/svg/china.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
.chinabutton:hover {
...
.custombutton {
  ...
  background: url(../../../../images/sunwayImg/svg/any.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
.custombutton:hover {
...
.defaultbutton {
  ...
  background: url(../../../../images/sunwayImg/svg/default.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
.defaultbutton:hover {
...
.vrbutton {
  background: url(../../../../images/vr.png) no-repeat;
    background: url(../../../../images/sunwayImg/svg/VR.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
.vrbutton:hover {
...
.gooleearthbutton {
  ...
  background: url(../../../../images/sunwayImg/svg/gooleearth.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
.gooleearthbutton:hover {
  background: url(../../../../images/gooleearth_on.png) no-repeat;
  background: url(../../../../images/sunwayImg/svg/goole.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
...
.firstpersonbutton {
  ...
  background: url(../../../../images/sunwayImg/svg/firstperson.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
...
.mousebutton {
  ...
  background: url(../../../../images/sunwayImg/svg/mousesvg.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
.mousebutton:hover {
...
.globalrotationbutton {
  ...
  background: url(../../../../images/sunwayImg/svg/earth-rotate.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
...
.centerrotationbutton {
  ...
  background: url(../../../../images/sunwayImg/svg/center.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
...
.savebutton {
  ...
  background: url(../../../../images/sunwayImg/svg/save.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
...
.cameraattachbutton {
  ...
  background: url(../../../../images/sunwayImg/svg/cameraattach.svg) no-repeat;
  background-size: contain;
  cursor: pointer;
}
