...
.sunway-title {
    ...
    min-width: 656px;
    z-index: -1;
    background:url("../../../images/sunwayImg/aimg-caijian1.jpg") no-repeat;
    background-size:100% 137px; 
    background-attachment:fixed;;
  /* background: linear-gradient(to right, rgb(128, 127, 127), rgb(126, 126, 128),rgb(73, 73, 73),rgb(17, 17, 17));
  background: linear-gradient(to right, rgb(104, 102, 102), rgb(62, 62, 63),rgb(56, 56, 56),rgb(17, 17, 17));
  background: linear-gradient(to right, rgb(128, 127, 127), rgb(126, 126, 128),rgb(97, 97, 97),rgb(61, 61, 61)); */
}
.xbsj-title-ul {
  /* margin: 0;
  padding: 0;
  ...
  /* background: #474747;
  background: #9baef1;
  background:url("../../../images/sunwayImg/timg.jpg");
  background: rgba(2,64,146,0.5);
  background: rgba(0,76,152,1);
  background: rgb(2, 87, 172);
  background:url("../../../images/sunwayImg/aimg.jpg");
  background:url("../../../images/sunwayImg/cimg.jpg");
  background:url("../../../images/sunwayImg/h.jpg");
  background:url("../../../images/sunwayImg/gimg.jpg");
  background-position-y:-20px;
  background:url("../../../images/sunwayImg/iimg.jpg");
  background:url("../../../images/sunwayImg/jimg.jpg");
  ...
  /* background: linear-gradient(to right, rgb(104, 102, 102), rgb(62, 62, 63),rgb(56, 56, 56),rgb(17, 17, 17)); */
  /* background: linear-gradient(to right, rgb(128, 127, 127), rgb(126, 126, 128),rgb(97, 97, 97),rgb(61, 61, 61)); */
  /* background: linear-gradient(to right, rgb(180, 179, 179), rgb(57, 57, 58),rgb(32, 32, 32),rgb(17, 17, 17)); */
